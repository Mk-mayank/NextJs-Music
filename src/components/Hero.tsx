...
function Hero() {
  return (
    <div
      className="min-h-screen w-full rounded-md flex flex-col items-center justify-center relative overflow-hidden mx-auto py-10 md:py-0"
    >
      <Spotlight
      ...
      <div className="p-4 relative z-10 w-full text-center">
        ...
        <p className="mt-8 mb-8 font-normal text-base md:text-lg text-neutral-300 max-w-lg mx-auto">
        ...
        <div className="mt-4">
          <Link href="/courses">
            <Button
              ...
              className="bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-gray-100 border-neutral-400 dark:border-slate-800"
            >
              Explore courses
            </Button>
          </Link>
